...
Public Class MainMenu
    ...
    Private Sub SetupPieces()
        ...
        WK1.Location = New Point(300, 0)
        WQ1.Location = New Point(225, 0)
        BK1.Location = New Point(300, 525)
        BQ1.Location = New Point(225, 525)
        WB1.Location = New Point(150, 0)
        WB2.Location = New Point(375, 0)
        BB1.Location = New Point(150, 525)
        BB2.Location = New Point(375, 525)
        WN1.Location = New Point(75, 0)
        WN2.Location = New Point(450, 0)
        BN1.Location = New Point(75, 525)
        BN2.Location = New Point(450, 525)
        WR1.Location = New Point(0, 0)
        WR2.Location = New Point(525, 0)
        BR1.Location = New Point(0, 525)
        BR2.Location = New Point(525, 525)

        WP1.Location = New Point(0, 75)
        WP2.Location = New Point(525, 75)
        BP1.Location = New Point(0, 450)
        BP2.Location = New Point(525, 450)
        WP3.Location = New Point(75, 75)
        WP4.Location = New Point(450, 75)
        BP3.Location = New Point(75, 450)
        BP4.Location = New Point(450, 450)
        WP5.Location = New Point(150, 75)
        WP6.Location = New Point(375, 75)
        BP5.Location = New Point(150, 450)
        BP6.Location = New Point(375, 450)
        WP7.Location = New Point(225, 75)
        WP8.Location = New Point(300, 75)
        BP7.Location = New Point(225, 450)
        BP8.Location = New Point(300, 450)
    End Sub
